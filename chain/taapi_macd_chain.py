...
class TaapiMACDChain(Chain):
    ...
    @classmethod
    def from_llm(cls,llm:BaseLanguageModel,taapi_secret: str,**kwargs: Any,)->TaapiMACDChain:
        docs_template=PromptTemplate(input_variables=["taapi_key"],template=taapi_docs.MACD_API_DOCS)
        ...
        question_template=PromptTemplate(input_variables=["input"],template=taapi_templates.GENERATE_MACD_QUESTION)
