...
class TaapiPSARChain(Chain):
    ...
    @classmethod
    def from_llm(cls,llm:BaseLanguageModel,taapi_secret: str,**kwargs: Any,)->TaapiPSARChain:
        docs_template=PromptTemplate(input_variables=["taapi_key"],template=taapi_docs.PSAR_API_DOCS)
        ...
        question_template=PromptTemplate(input_variables=["input"],template=taapi_templates.GENERATE_PSAR_QUESTION)
        ...
        conclusion_template=PromptTemplate(input_variables=["data"],template=taapi_templates.PSAR_CONCLUSION) 
