...
class TaapiDMIChain(Chain):
    ...
    @classmethod
    def from_llm(cls,llm:BaseLanguageModel,taapi_secret: str,**kwargs: Any,)->TaapiDMIChain:
        docs_template=PromptTemplate(input_variables=["taapi_key"],template=taapi_docs.DMI_API_DOCS)
        ...
        question_template=PromptTemplate(input_variables=["input"],template=taapi_templates.GENERATE_DMI_QUESTION)
        ...
        conclusion_template=PromptTemplate(input_variables=["data"],template=taapi_templates.DMI_CONCLUSION) 
