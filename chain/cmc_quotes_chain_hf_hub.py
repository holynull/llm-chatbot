...
class CMCQuotesChain(Chain):
    ...
    def from_llm(cls,llm:BaseLanguageModel,headers:dict,**kwargs: Any,)->CMCQuotesChain:
        ...
        api_req_llm=HuggingFaceHub(repo_id=repo_id, model_kwargs={"temperature":0.7, "max_length":64})
        api_res_llm=HuggingFaceHub(repo_id=repo_id, model_kwargs={"temperature":0.7, "max_length":64})
        ...
        product_llm=HuggingFaceHub(repo_id=repo_id, model_kwargs={"temperature":0.7, "max_length":64})
